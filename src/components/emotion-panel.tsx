...
export function EmotionPanel({ emotions, busy }: Props) {
  ...
  return (
    <aside className="hidden h-dvh min-h-0 flex-col border-l border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/50 lg:flex">
            ...
            {sorted.map(([label, g]) => (
              ...
              >
                <div className="flex items-baseline justify-between gap-2">
                  <span className="text-sm font-medium lowercase text-zinc-900 dark:text-zinc-50">{label}</span>
