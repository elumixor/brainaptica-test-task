...
| 5 | `I just don't see the point of any of it anymore.` | `hopelessness` / `despair`, possibly with a soft crisis flag | Crisis-adjacent. We do **not** auto-route to a hotline (see issues.md #5) — the listener prompt keeps listening, the extractor labels the affect. |
